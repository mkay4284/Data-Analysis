function LS_CamLOT01_Drift_SpectrumPlots(Adjhdata,Adjvdata,t,mmlim,uradlim,L)
...
title('CamLOT01 Horizontal Drift'); xlabel('Timestamp'); ylabel('X_c (mm)'); 
...
title('CamLOT01 Vertical Drift'); xlabel('Timestamp'); ylabel('Y_c (mm)'); vslim = ylim;
