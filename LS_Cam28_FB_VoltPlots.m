function LS_Cam28_FB_VoltPlots(Adjhdata,Adjvdata,t,mmlim,uradlim,V)
...
title('Cam28 Horizontal Position'); xlabel('Timestamp'); ylabel('X_c (mm)'); 
...
title('Cam 28Vertical Position'); xlabel('Timestamp'); ylabel('Y_c (mm)'); vslim = ylim;
